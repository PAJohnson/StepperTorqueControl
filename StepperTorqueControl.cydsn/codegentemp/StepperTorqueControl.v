// ======================================================================
// StepperTorqueControl.v generated from TopDesign.cysch
// 04/20/2020 at 10:06
...
module ADC_DelSig_v3_30_4 (
	...
	cy_clock_v1_0
		#(.id("81aca901-d001-4271-8cb6-57acba4cedb4/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("81aca901-d001-4271-8cb6-57acba4cedb4/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=1, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=2, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG32, CySetRegReplacementString=CY_SET_REG32, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=4294967292, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=4294967292, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=32, RunMode=0, UDB16=false, UDB24=false, UDB32=true, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC32, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=StepDir, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=StepDir, CY_INSTANCE_SHORT_NAME=StepDir, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=StepDir, )
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("796906ad-e76f-4814-995b-d9d3fcf46a51"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("239092f9-3a32-4052-a47c-ce6e0f69993f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ad337fc9-0cb9-476a-9c97-dfb5cc46597e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    assign Net_484 = Net_398 & Net_337;
	...
	cy_clock_v1_0
		#(.id("d4c89165-0313-4561-b951-a13df78357a0"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__x_ref_in_net;
	wire [0:0] tmpFB_0__x_ref_in_net;
	wire [0:0] tmpIO_0__x_ref_in_net;
	wire [0:0] tmpINTERRUPT_0__x_ref_in_net;
	electrical [0:0] tmpSIOVREF__x_ref_in_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		x_ref_in
		 (.oe(tmpOE__x_ref_in_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__x_ref_in_net[0:0]}),
		  .analog({Net_301}),
		  .io({tmpIO_0__x_ref_in_net[0:0]}),
		  .siovref(tmpSIOVREF__x_ref_in_net),
		  .interrupt({tmpINTERRUPT_0__x_ref_in_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__x_ref_in_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyControlReg_v1_80 Step_reg (
        .control_1(Net_485),
        .control_2(Net_327),
        .control_3(Net_328),
        .control_0(Net_337),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Step_reg.Bit0Mode = 0;
    defparam Step_reg.Bit1Mode = 0;
    defparam Step_reg.Bit2Mode = 0;
    defparam Step_reg.Bit3Mode = 0;
    defparam Step_reg.Bit4Mode = 0;
    defparam Step_reg.Bit5Mode = 0;
    defparam Step_reg.Bit6Mode = 0;
    defparam Step_reg.Bit7Mode = 0;
    defparam Step_reg.BitValue = 0;
    defparam Step_reg.BusDisplay = 0;
    defparam Step_reg.ExtrReset = 0;
    defparam Step_reg.NumOutputs = 2;
    ...
    CyControlReg_v1_80 Microstep (
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Microstep.Bit0Mode = 0;
    defparam Microstep.Bit1Mode = 0;
    defparam Microstep.Bit2Mode = 0;
    defparam Microstep.Bit3Mode = 0;
    defparam Microstep.Bit4Mode = 0;
    defparam Microstep.Bit5Mode = 0;
    defparam Microstep.Bit6Mode = 0;
    defparam Microstep.Bit7Mode = 0;
    defparam Microstep.BitValue = 0;
    defparam Microstep.BusDisplay = 0;
    defparam Microstep.ExtrReset = 0;
    defparam Microstep.NumOutputs = 3;

	wire [0:0] tmpOE__MS1_net;
	wire [0:0] tmpFB_0__MS1_net;
	wire [0:0] tmpIO_0__MS1_net;
	wire [0:0] tmpINTERRUPT_0__MS1_net;
	electrical [0:0] tmpSIOVREF__MS1_net;

	cy_psoc3_pins_v1_10
		#(.id("fae024cd-ae98-4053-a414-3c37270f7144"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		MS1
		 (.oe(tmpOE__MS1_net),
		  .y({Net_391}),
		  .fb({tmpFB_0__MS1_net[0:0]}),
		  .io({tmpIO_0__MS1_net[0:0]}),
		  .siovref(tmpSIOVREF__MS1_net),
		  .interrupt({tmpINTERRUPT_0__MS1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MS1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MS2_net;
	wire [0:0] tmpFB_0__MS2_net;
	wire [0:0] tmpIO_0__MS2_net;
	wire [0:0] tmpINTERRUPT_0__MS2_net;
	electrical [0:0] tmpSIOVREF__MS2_net;

	cy_psoc3_pins_v1_10
		#(.id("adc1660a-3258-4f80-b3ad-6937e3b21ad8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		MS2
		 (.oe(tmpOE__MS2_net),
		  .y({Net_388}),
		  .fb({tmpFB_0__MS2_net[0:0]}),
		  .io({tmpIO_0__MS2_net[0:0]}),
		  .siovref(tmpSIOVREF__MS2_net),
		  .interrupt({tmpINTERRUPT_0__MS2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MS2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MS3_net;
	wire [0:0] tmpFB_0__MS3_net;
	wire [0:0] tmpIO_0__MS3_net;
	wire [0:0] tmpINTERRUPT_0__MS3_net;
	electrical [0:0] tmpSIOVREF__MS3_net;

	cy_psoc3_pins_v1_10
		#(.id("3e1e1459-c5ec-4989-bd1c-6e425752a82f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		MS3
		 (.oe(tmpOE__MS3_net),
		  .y({Net_389}),
		  .fb({tmpFB_0__MS3_net[0:0]}),
		  .io({tmpIO_0__MS3_net[0:0]}),
		  .siovref(tmpSIOVREF__MS3_net),
		  .interrupt({tmpINTERRUPT_0__MS3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MS3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_403 = Net_484 | Net_485 | Net_540;
	...
	cy_clock_v1_0
		#(.id("c23498a6-2733-4314-9a13-85edad77ccb4"),
		  .source_clock_id(""),
		  .divisor(0),
    ...
    CyStatusReg_v1_90 sw1_read (
        ...
        .intr(Net_429),
        .status_bus(8'b0));
    defparam sw1_read.Bit0Mode = 0;
    defparam sw1_read.Bit1Mode = 0;
    defparam sw1_read.Bit2Mode = 0;
    defparam sw1_read.Bit3Mode = 0;
    defparam sw1_read.Bit4Mode = 0;
    defparam sw1_read.Bit5Mode = 0;
    defparam sw1_read.Bit6Mode = 0;
    defparam sw1_read.Bit7Mode = 0;
    defparam sw1_read.BusDisplay = 0;
    defparam sw1_read.Interrupt = 0;
    defparam sw1_read.MaskValue = 0;
    defparam sw1_read.NumInputs = 1;


	cy_clock_v1_0
		#(.id("43b5f441-e3e7-4f3c-a168-ef27c1a03776"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("2000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Interrupt_t_net;
	wire [0:0] tmpFB_0__Interrupt_t_net;
	wire [0:0] tmpIO_0__Interrupt_t_net;
	wire [0:0] tmpINTERRUPT_0__Interrupt_t_net;
	electrical [0:0] tmpSIOVREF__Interrupt_t_net;

	cy_psoc3_pins_v1_10
		#(.id("ff4268d4-7174-4149-a088-c1038dabe6bb"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Interrupt_t
		 (.oe(tmpOE__Interrupt_t_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Interrupt_t_net[0:0]}),
		  .io({tmpIO_0__Interrupt_t_net[0:0]}),
		  .siovref(tmpSIOVREF__Interrupt_t_net),
		  .interrupt({tmpINTERRUPT_0__Interrupt_t_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Interrupt_t_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    Counter_v3_0_6 StepDir (
        .reset(Net_498),
        .tc(Net_499),
        .comp(Net_500),
        .clock(Net_501),
        ...
        .up_ndown(Net_507),
        .count(Net_508));
    defparam StepDir.CaptureMode = 0;
    defparam StepDir.ClockMode = 1;
    defparam StepDir.CompareMode = 1;
    defparam StepDir.CompareStatusEdgeSense = 1;
    defparam StepDir.EnableMode = 0;
    defparam StepDir.ReloadOnCapture = 0;
    defparam StepDir.ReloadOnCompare = 0;
    defparam StepDir.ReloadOnOverUnder = 1;
    defparam StepDir.ReloadOnReset = 1;
    defparam StepDir.Resolution = 32;
    defparam StepDir.RunMode = 0;
    defparam StepDir.UseInterrupt = 1;


	cy_clock_v1_0
		#(.id("31211df9-8b37-4c62-abf8-929e7eb5dec0"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__DIR_IN_net;
	wire [0:0] tmpIO_0__DIR_IN_net;
	wire [0:0] tmpINTERRUPT_0__DIR_IN_net;
	electrical [0:0] tmpSIOVREF__DIR_IN_net;

	cy_psoc3_pins_v1_10
		#(.id("b1b524a3-8573-496b-91c3-32b0f192a8eb"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		DIR_IN
		 (.oe(tmpOE__DIR_IN_net),
		  .y({1'b0}),
		  .fb({Net_507}),
		  .io({tmpIO_0__DIR_IN_net[0:0]}),
		  .siovref(tmpSIOVREF__DIR_IN_net),
		  .interrupt({tmpINTERRUPT_0__DIR_IN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DIR_IN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__STEP_IN_net;
	wire [0:0] tmpIO_0__STEP_IN_net;
	wire [0:0] tmpINTERRUPT_0__STEP_IN_net;
	electrical [0:0] tmpSIOVREF__STEP_IN_net;

	cy_psoc3_pins_v1_10
		#(.id("d3534060-6647-41f2-a9d2-9b1a0a8b45ad"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		STEP_IN
		 (.oe(tmpOE__STEP_IN_net),
		  .y({1'b0}),
		  .fb({Net_508}),
		  .io({tmpIO_0__STEP_IN_net[0:0]}),
		  .siovref(tmpSIOVREF__STEP_IN_net),
		  .interrupt({tmpINTERRUPT_0__STEP_IN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__STEP_IN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
